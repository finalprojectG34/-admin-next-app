            ...
            <Drawer variant="permanent" open={open}>
                ...
                <List>
                    {userOptions.map((options, index) => (
                        <Link href={options.link} key={options.link}>
                            <ListItem key={options.text} disablePadding sx={{display: 'block'}}>
                                <ListItemButton
                                    sx={{
                                        minHeight: 48,
                                ...
                                >
                                    ...
                                    <ListItemText primary={options.text} sx={{opacity: open ? 1 : 0}}/>
                                </ListItemButton>
                            </ListItem>
                        </Link>
                    ))}
                ...
                <List>
                    {shopOptions.map((options, index) => (
                        <Link href={options.link} key={options.link}>
                            <ListItem key={options.link} disablePadding sx={{display: 'block'}}>
                                <ListItemButton
                                    sx={{
                                        minHeight: 48,
                                        justifyContent: open ? 'initial' : 'center',
